...
class SentimentAnalyzerServiceCdkStack(Stack):
    ...
    def create_sm_endpoint(self) -> None:
        ...
        sentiment_handler = lambda_.Function(
            ...
            code=lambda_.Code.from_asset("stacks/sentiment_analyzer_service/lambda/fetch-sentiments-handler"),
        ...
        sagemaker_policy_statement = iam.Policy(self, 'Policy', statements= [iam.PolicyStatement(
        ...
        fetch_sentiments_integration = apigw_.LambdaIntegration(
            sentiment_handler,
            request_templates={"application/json": '{ "statusCode": "200" }'},
        )

        api.root.add_method("GET", fetch_sentiments_integration)  # GET /
        self.sentiment_api_arn = api.arn_for_execute_api
